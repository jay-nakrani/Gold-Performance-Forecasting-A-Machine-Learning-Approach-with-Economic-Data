...
def plot_combined_data(combined_df):
    ...
    save_plot("All features trend from combined dataset")
    plt.tight_layout()
    plt.show()
...
def plot_gold_inflation_correlation(df):
    ...
    plt.legend()
    plt.tight_layout()
    save_plot("Gold-Inflation Correlation")
    plt.show()
...
def plot_gold_vs_inflation(df):
    ...
    save_plot("Gold prices during high inflation periods")
    plt.show()
...
def plot_correlation_heatmap(df, figsize):
    ...
    plt.tight_layout()
    save_plot("Correlation matrix (daily percentage change)")
    plt.show()
